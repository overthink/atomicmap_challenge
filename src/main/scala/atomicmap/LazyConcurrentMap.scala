 ...
 */
class LazyConcurrentMap[A, B] extends ConcurrentMap[A, B] {

  // Helper wrapper to control evaluation time
  ...
  private val _underlying: ConcurrentMap[A, Lazy[B]] = new ConcurrentHashMap[A, Lazy[B]]  // implicit: asScalaConcurrentMap()
